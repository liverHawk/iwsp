...
export default function JapanMap({ 
  ...
  const [tooltip, setTooltip] = useState<{
    ...
    name: string;
    count: number;
  }>({ show: false, x: 0, y: 0, name: "", count: 0 });

  // 応援データの最大値を取得（グラデーション用）
  const counts = Object.values(cheerData);
  ...
  const getPrefColor = (code: string) => {
    ...
    // 応援数に応じて、深みのあるアンバーゴールドからネオンレッドへのグラデーション
    // ratio=0: rgba(243, 156, 18, 0.3)  (アンバーゴールド)
    // ratio=1: rgba(231, 76, 60, 0.95)  (ネオンレッド)
    const r = Math.round(243 - ratio * 12);
    const g = Math.round(156 - ratio * 80);
    const b = Math.round(18 + ratio * 42);
  ...
  return (
    <div className="japan-map-wrapper">
      <svg className="geolonia-svg-map" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
        <title>Japanese Prefectures Heatmap</title>
        <g className="svg-map" transform="matrix(1.453488, 0, 0, 1.453488, -435.334259, -216.944946)">
          <g className="prefectures" transform="matrix(1, 0, 0, 1, 6, 18)">
            {/* 沖縄 */}
            <g className={`okinawa kyushu-okinawa prefecture ${selectedPrefId === "47" ? "selected" : ""}`} data-code="47" strokeLinejoin="round" transform="matrix(0.999391, -0.0349, 0.0349, 0.999391, 219.771561, 844.318481)" fillRule="nonzero" {...getPrefProps("47", "沖縄県")}>
            ...
            {/* 鹿児島 */}
            <g className={`kagoshima kyushu kyushu-okinawa prefecture ${selectedPrefId === "46" ? "selected" : ""}`} data-code="46" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 345.509979, -137.365875)" fillRule="nonzero" {...getPrefProps("46", "鹿児島県")}>
            ...
            {/* 宮崎 */}
            <g className={`miyazaki kyushu kyushu-okinawa prefecture ${selectedPrefId === "45" ? "selected" : ""}`} data-code="45" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 401.509979, 669.634094)" fillRule="nonzero" {...getPrefProps("45", "宮崎県")}>
            ...
            {/* 大分 */}
            <g className={`oita kyushu kyushu-okinawa prefecture ${selectedPrefId === "44" ? "selected" : ""}`} data-code="44" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 412.509979, 616.634094)" fillRule="nonzero" {...getPrefProps("44", "大分県")}>
            ...
            {/* 熊本 */}
            <g className={`kumamoto kyushu kyushu-okinawa prefecture ${selectedPrefId === "43" ? "selected" : ""}`} data-code="43" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 364.509979, 645.634094)" fillRule="nonzero" {...getPrefProps("43", "熊本県")}>
            ...
            {/* 長崎 */}
            <g className={`nagasaki kyushu kyushu-okinawa prefecture ${selectedPrefId === "42" ? "selected" : ""}`} data-code="42" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 293.509979, 545.634094)" fillRule="nonzero" {...getPrefProps("42", "長崎県")}>
            ...
            {/* 佐賀 */}
            <g className={`saga kyushu kyushu-okinawa prefecture ${selectedPrefId === "41" ? "selected" : ""}`} data-code="41" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 357.509979, 618.634094)" fillRule="nonzero" {...getPrefProps("41", "佐賀県")}>
            ...
            {/* 福岡 */}
            <g className={`fukuoka kyushu kyushu-okinawa prefecture ${selectedPrefId === "40" ? "selected" : ""}`} data-code="40" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 372.509979, 597.634094)" fillRule="nonzero" {...getPrefProps("40", "福岡県")}>
            ...
            {/* 高知 */}
            <g className={`kochi shikoku prefecture ${selectedPrefId === "39" ? "selected" : ""}`} data-code="39" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 500.509979, 610.634094)" fillRule="nonzero" {...getPrefProps("39", "高知県")}>
            ...
            {/* 愛媛 */}
            <g className={`ehime shikoku prefecture ${selectedPrefId === "38" ? "selected" : ""}`} data-code="38" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 474.509979, 582.634094)" fillRule="nonzero" {...getPrefProps("38", "愛媛県")}>
            ...
            {/* 香川 */}
            <g className={`kagawa shikoku prefecture ${selectedPrefId === "37" ? "selected" : ""}`} data-code="37" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 557.51001, 569.634094)" fillRule="nonzero" {...getPrefProps("37", "香川県")}>
            ...
            {/* 徳島 */}
            <g className={`tokushima shikoku prefecture ${selectedPrefId === "36" ? "selected" : ""}`} data-code="36" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 561.51001, 589.634094)" fillRule="nonzero" {...getPrefProps("36", "徳島県")}>
            ...
            {/* 山口 */}
            <g className={`yamaguchi chugoku prefecture ${selectedPrefId === "35" ? "selected" : ""}`} data-code="35" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 417.509979, 555.634094)" fillRule="nonzero" {...getPrefProps("35", "山口県")}>
            ...
            {/* 広島 */}
            <g className={`hiroshima chugoku prefecture ${selectedPrefId === "34" ? "selected" : ""}`} data-code="34" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 479.509979, 532.634094)" fillRule="nonzero" {...getPrefProps("34", "広島県")}>
            ...
            {/* 岡山 */}
            <g className={`okayama chugoku prefecture ${selectedPrefId === "33" ? "selected" : ""}`} data-code="33" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 544.51001, 518.634094)" fillRule="nonzero" {...getPrefProps("33", "岡山県")}>
            ...
            {/* 島根 */}
            <g className={`shimane chugoku prefecture ${selectedPrefId === "32" ? "selected" : ""}`} data-code="32" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 460.509979, 455.634125)" fillRule="nonzero" {...getPrefProps("32", "島根県")}>
            ...
            {/* 鳥取 */}
            <g className={`tottori chugoku prefecture ${selectedPrefId === "31" ? "selected" : ""}`} data-code="31" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 537.51001, 503.634094)" fillRule="nonzero" {...getPrefProps("31", "鳥取県")}>
            ...
            {/* 和歌山 */}
            <g className={`wakayama kinki prefecture ${selectedPrefId === "30" ? "selected" : ""}`} data-code="30" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 634.51001, 582.634094)" fillRule="nonzero" {...getPrefProps("30", "和歌山県")}>
            ...
            {/* 奈良 */}
            <g className={`nara kinki prefecture ${selectedPrefId === "29" ? "selected" : ""}`} data-code="29" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 659.51001, 557.634094)" fillRule="nonzero" {...getPrefProps("29", "奈良県")}>
            ...
            {/* 兵庫 */}
            <g className={`hyogo kinki prefecture ${selectedPrefId === "28" ? "selected" : ""}`} data-code="28" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 594.51001, 500.634094)" fillRule="nonzero" {...getPrefProps("28", "兵庫県")}>
            ...
            {/* 大阪 */}
            <g className={`osaka kinki prefecture ${selectedPrefId === "27" ? "selected" : ""}`} data-code="27" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 636.51001, 540.634094)" fillRule="nonzero" {...getPrefProps("27", "大阪府")}>
            ...
            {/* 京都 */}
            <g className={`kyoto kinki prefecture ${selectedPrefId === "26" ? "selected" : ""}`} data-code="26" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 626.51001, 494.634125)" fillRule="nonzero" {...getPrefProps("26", "京都府")}>
            ...
            {/* 滋賀 */}
            <g className={`shiga kinki prefecture ${selectedPrefId === "25" ? "selected" : ""}`} data-code="25" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 672.51001, 500.634094)" fillRule="nonzero" {...getPrefProps("25", "滋賀県")}>
            ...
            {/* 三重 */}
            <g className={`mie kinki prefecture ${selectedPrefId === "24" ? "selected" : ""}`} data-code="24" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 675.51001, 528.634094)" fillRule="nonzero" {...getPrefProps("24", "三重県")}>
            ...
            {/* 愛知 */}
            <g className={`aichi chubu prefecture ${selectedPrefId === "23" ? "selected" : ""}`} data-code="23" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 718.51001, 518.634094)" fillRule="nonzero" {...getPrefProps("23", "愛知県")}>
            ...
            {/* 静岡 */}
            <g className={`shizuoka chubu prefecture ${selectedPrefId === "22" ? "selected" : ""}`} data-code="22" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 760.51001, 504.634094)" fillRule="nonzero" {...getPrefProps("22", "静岡県")}>
            ...
            {/* 岐阜 */}
            <g className={`gifu chubu prefecture ${selectedPrefId === "21" ? "selected" : ""}`} data-code="21" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 699.51001, 453.634125)" fillRule="nonzero" {...getPrefProps("21", "岐阜県")}>
            ...
            {/* 長野 */}
            <g className={`nagano chubu prefecture ${selectedPrefId === "20" ? "selected" : ""}`} data-code="20" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 752.51001, 417.634125)" fillRule="nonzero" {...getPrefProps("20", "長野県")}>
            ...
            {/* 山梨 */}
            <g className={`yamanashi chubu prefecture ${selectedPrefId === "19" ? "selected" : ""}`} data-code="19" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 795.51001, 483.634125)" fillRule="nonzero" {...getPrefProps("19", "山梨県")}>
            ...
            {/* 福井 */}
            <g className={`fukui chubu prefecture ${selectedPrefId === "18" ? "selected" : ""}`} data-code="18" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 657.51001, 463.634125)" fillRule="nonzero" {...getPrefProps("18", "福井県")}>
            ...
            {/* 石川 */}
            <g className={`ishikawa chubu prefecture ${selectedPrefId === "17" ? "selected" : ""}`} data-code="17" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 697.51001, 386.634125)" fillRule="nonzero" {...getPrefProps("17", "石川県")}>
            ...
            {/* 富山 */}
            <g className={`toyama chubu prefecture ${selectedPrefId === "16" ? "selected" : ""}`} data-code="16" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 724.51001, 420.634125)" fillRule="nonzero" {...getPrefProps("16", "富山県")}>
            ...
            {/* 新潟 */}
            <g className={`niigata chubu prefecture ${selectedPrefId === "15" ? "selected" : ""}`} data-code="15" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 767.51001, 321.634125)" fillRule="nonzero" {...getPrefProps("15", "新潟県")}>
            ...
            {/* 神奈川 */}
            <g className={`kanagawa kanto prefecture ${selectedPrefId === "14" ? "selected" : ""}`} data-code="14" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 833.51001, 501.634094)" fillRule="nonzero" {...getPrefProps("14", "神奈川県")}>
            ...
            {/* 東京 */}
            <g className={`tokyo kanto prefecture ${selectedPrefId === "13" ? "selected" : ""}`} data-code="13" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 834.51001, 487.634125)" fillRule="nonzero" {...getPrefProps("13", "東京都")}>
            ...
            {/* 千葉 */}
            <g className={`chiba kanto prefecture ${selectedPrefId === "12" ? "selected" : ""}`} data-code="12" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 876.51001, 474.634125)" fillRule="nonzero" {...getPrefProps("12", "千葉県")}>
            ...
            {/* 埼玉 */}
            <g className={`saitama kanto prefecture ${selectedPrefId === "11" ? "selected" : ""}`} data-code="11" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 822.51001, 463.634125)" fillRule="nonzero" {...getPrefProps("11", "埼玉県")}>
            ...
            {/* 群馬 */}
            <g className={`gunma kanto prefecture ${selectedPrefId === "10" ? "selected" : ""}`} data-code="10" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 806.51001, 415.634125)" fillRule="nonzero" {...getPrefProps("10", "群馬県")}>
            ...
            {/* 栃木 */}
            <g className={`tochigi kanto prefecture ${selectedPrefId === "09" ? "selected" : ""}`} data-code="09" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 852.51001, 408.634125)" fillRule="nonzero" {...getPrefProps("09", "栃木県")}>
            ...
            {/* 茨城 */}
            <g className={`ibaraki kanto prefecture ${selectedPrefId === "08" ? "selected" : ""}`} data-code="08" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 871.51001, 420.634125)" fillRule="nonzero" {...getPrefProps("08", "茨城県")}>
            ...
            {/* 福島 */}
            <g className={`fukushima tohoku prefecture ${selectedPrefId === "07" ? "selected" : ""}`} data-code="07" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 843.51001, 356.634125)" fillRule="nonzero" {...getPrefProps("07", "福島県")}>
            ...
            {/* 山形 */}
            <g className={`yamagata tohoku prefecture ${selectedPrefId === "06" ? "selected" : ""}`} data-code="06" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 861.51001, 284.634125)" fillRule="nonzero" {...getPrefProps("06", "山形県")}>
            ...
            {/* 秋田 */}
            <g className={`akita tohoku prefecture ${selectedPrefId === "05" ? "selected" : ""}`} data-code="05" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 866.51001, 197.634125)" fillRule="nonzero" {...getPrefProps("05", "秋田県")}>
            ...
            {/* 宮城 */}
            <g className={`miyagi tohoku prefecture ${selectedPrefId === "04" ? "selected" : ""}`} data-code="04" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 897.51001, 290.634125)" fillRule="nonzero" {...getPrefProps("04", "宮城県")}>
            ...
            {/* 岩手 */}
            <g className={`iwate tohoku prefecture ${selectedPrefId === "03" ? "selected" : ""}`} data-code="03" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 913.51001, 199.634125)" fillRule="nonzero" {...getPrefProps("03", "岩手県")}>
            ...
            {/* 青森 */}
            <g className={`aomori tohoku prefecture ${selectedPrefId === "02" ? "selected" : ""}`} data-code="02" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 873.51001, 132.634125)" fillRule="nonzero" {...getPrefProps("02", "青森県")}>
            ...
            {/* 北海道 */}
            <g className={`hokkaido prefecture ${selectedPrefId === "01" ? "selected" : ""}`} data-code="01" strokeLinejoin="round" transform="matrix(1, 0, 0, 1, 328.506958, 152.38652)" fillRule="nonzero" {...getPrefProps("01", "北海道")}>
          ...
          {/* 境界線と引出線 */}
          <g className="boundary-line" stroke="#ffffff" strokeOpacity="0.2" strokeWidth="6" strokeLinejoin="round" transform="matrix(0.954119, 0, 0, 1, 15.739344, 0)">
      ...
      {tooltip.show && (
        ...
        >
          ...
          <div className="tooltip-count">
            <span className="count-num">{tooltip.count.toLocaleString()}</span> Cheers
          </div>
        </div>
      )}
    </div>
